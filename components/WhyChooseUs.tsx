...
const reasons = [
  {
    ...
    description:
      "Une équipe dotée d'une expertise et d'un savoir-faire reconnus dans le domaine du chauffage et de la plomberie.",
    icon: (
  ...
  },
  {
    ...
    title: "La qualité",
    description:
      "Nous travaillons exclusivement avec des marques de haute qualité : Vaillant, Viessmann, Grohe, Geberit et bien d'autres.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    title: "Le prix",
    description:
      "Des prix compétitifs pour des services de qualité professionnelle, sans compromis sur la fiabilité.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Joignables 7 jours sur 7 pour répondre à vos urgences et à vos demandes dans les meilleurs délais.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll animation="fadeUp" className="text-center mb-16">
          ...
          <p className="text-body-secondary text-lg max-w-2xl mx-auto mt-6">
            Découvrez pourquoi nos clients nous font confiance depuis des
            années pour leurs travaux de plomberie et de chauffage.
          </p>
        </AnimateOnScroll>
